...
var format_Titik_Per50_m_14 = new ol.format.GeoJSON();
var features_Titik_Per50_m_14 = format_Titik_Per50_m_14.readFeatures(json_Titik_Per50_m_14, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Titik_Per50_m_14 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Titik_Per50_m_14.addFeatures(features_Titik_Per50_m_14);
var lyr_Titik_Per50_m_14 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Titik_Per50_m_14, 
                style: style_Titik_Per50_m_14,
                popuplayertitle: 'Titik_Per-50_m',
                interactive: true,
                title: '<img src="styles/legend/Titik_Per50_m_14.png" /> Titik_Per-50_m'
            });
...
var group_TITIKKETERANGAN = new ol.layer.Group({
                                layers: [lyr_Tikungan_11,lyr_Beda_Pasangan_12,lyr_Gorong__Gorong_13,lyr_Titik_Per50_m_14,],
                                fold: 'open',
...
lyr_GoogleSatelliteHybrid_0.setVisible(false);lyr_GoogleSatellite_1.setVisible(true);lyr_GoogleRoads_2.setVisible(false);lyr_OpenTopoMap_3.setVisible(false);lyr_Sungai_4.setVisible(true);lyr_Jalan_5.setVisible(true);lyr_AreaFungsional_6.setVisible(true);lyr_KETERANGAN_KERUSAKAN_SALURAN_7.setVisible(true);lyr_JENIS_SALURAN_8.setVisible(true);lyr_AREANOMENKLATUR_9.setVisible(true);lyr_BANGUNANNOMENKLATUR_10.setVisible(true);lyr_Tikungan_11.setVisible(true);lyr_Beda_Pasangan_12.setVisible(true);lyr_Gorong__Gorong_13.setVisible(true);lyr_Titik_Per50_m_14.setVisible(true);lyr_Bangunan_Air_15.setVisible(true);lyr_Bangunan_Bagi_16.setVisible(true);lyr_Bangunan_Sadap_17.setVisible(true);lyr_Rumah_Pompa_18.setVisible(true);
var layersList = [lyr_GoogleSatelliteHybrid_0,lyr_GoogleSatellite_1,lyr_GoogleRoads_2,lyr_OpenTopoMap_3,lyr_Sungai_4,lyr_Jalan_5,lyr_AreaFungsional_6,lyr_KETERANGAN_KERUSAKAN_SALURAN_7,lyr_JENIS_SALURAN_8,group_SKEMANOMENKLATUR,group_TITIKKETERANGAN,group_TITIKAKSESSORIS];
...
lyr_AreaFungsional_6.set('fieldAliases', {'Id': 'Id', 'AREA': 'AREA', 'LUAS': 'LUAS', });
...
lyr_BANGUNANNOMENKLATUR_10.set('fieldAliases', {'NAME': 'NAME', 'PANJANG': 'PANJANG', 'FOTO_1': 'FOTO_1', 'FOTO_2': 'FOTO_2', 'FOTO_3': 'FOTO_3', 'FOTO_4': 'FOTO_4', 'URUTAN': 'URUTAN', 'POSISI': 'POSISI', });
...
lyr_Titik_Per50_m_14.set('fieldAliases', {'NAME': 'NAME', 'Descriptio': 'Descriptio', 'pdfmaps_ph': 'pdfmaps_ph', 'X': 'X', 'Y': 'Y', 'BUJUR': 'BUJUR', 'LINTANG': 'LINTANG', 'PANJANG': 'PANJANG', 'FOTO_1': 'FOTO_1', 'FOTO_2': 'FOTO_2', 'FOTO_3': 'FOTO_3', 'FOTO_4': 'FOTO_4', 'FOTO_5': 'FOTO_5', 'FOTO_6': 'FOTO_6', 'FOTO_7': 'FOTO_7', 'FOTO_8': 'FOTO_8', });
...
lyr_AreaFungsional_6.set('fieldImages', {'Id': 'Range', 'AREA': 'TextEdit', 'LUAS': 'TextEdit', });
...
lyr_BANGUNANNOMENKLATUR_10.set('fieldImages', {'NAME': 'TextEdit', 'PANJANG': 'TextEdit', 'FOTO_1': 'TextEdit', 'FOTO_2': 'TextEdit', 'FOTO_3': 'TextEdit', 'FOTO_4': 'TextEdit', 'URUTAN': 'TextEdit', 'POSISI': 'TextEdit', });
...
lyr_AreaFungsional_6.set('fieldLabels', {'Id': 'hidden field', 'AREA': 'inline label - visible with data', 'LUAS': 'inline label - visible with data', });
...
lyr_BANGUNANNOMENKLATUR_10.set('fieldLabels', {'NAME': 'no label', 'PANJANG': 'no label', 'FOTO_1': 'no label', 'FOTO_2': 'no label', 'FOTO_3': 'no label', 'FOTO_4': 'no label', 'URUTAN': 'no label', 'POSISI': 'no label', });
